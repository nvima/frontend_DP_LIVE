    ...
    return (
        <Layout
            ...
            description={intl.formatMessage({
                defaultMessage:
                    'Häufig gestellte Fragen zu Delivery Plus. FAQ zur Zahlung, Shop und Homepage.',
            })}
            noindex={false}
            nofollow={false}
            openGraph={{
                ...
                <div className="py-12 md:py-24 max-w-xl sm:mx-auto lg:max-w-2xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <FaqDropdown
                            ...
                            description={intl.formatMessage({
                                defaultMessage:
                                    'Natürlich, du kannst jedes Bild austauschen.',
                            })}
                        />
                        <FaqDropdown
                            title={intl.formatMessage({
