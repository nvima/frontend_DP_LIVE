export const PrivacyPolicyEs = () => {
  return (
    <div>
      ...
      <p>Delivery+</p>
      <p>info@delivery.plus</p>
      <h2 className='py-4 font-semibold text-lg'>Ihre Betroffenenrechte</h2>
      ...
      <h3 className='pb-2 text-base'>Art und Zweck der Verarbeitung:</h3>
      <p>
      ...
      <h3 className='py-2 text-base'>Empfänger:</h3>
      <p>
      ...
      <p></p>
      <h3 className='py-2 text-base'>Speicherdauer:</h3>
      <p>
      ...
      <p></p>
      <h2 className='py-4 font-semibold text-lg'>Cookies</h2>
      <p>
      ...
      <h3 className='py-2 text-base'>Speicherdauer und eingesetzte Cookies:</h3>
      <p>
      ...
      <p>
        Login Session - 365 Tage (Teschnich notwendig, da sonst der Login
        funktioniert)
      </p>
      <h2 className='py-4 font-semibold text-lg'>
        Technisch notwendige Cookies{' '}
      </h2>
      <h3 className='py-2 text-base'>Art und Zweck der Verarbeitung: </h3>
      <p>
      ...
      <h3 className='py-2 text-base'>Widerspruch</h3>
      <p>
      ...
      <h3 className='py-2 text-base'>Rechtsgrundlage:</h3>
      <p>
      ...
      <p></p>
      <h2 className='py-4 font-semibold text-lg'>Newsletter</h2>
      <h3 className='py-2 text-base'>Art und Zweck der Verarbeitung:</h3>
      <p>
      ...
      <h3 className='py-2 text-base'>Widerruf der Einwilligung:</h3>
      <p>
        Die Einwilligung zur Speicherung Ihrer persönlichen Daten und ihrer
        Nutzung für den Newsletterversand können Sie jederzeit mit Wirkung für
      ...
      <p></p>
      <h2 className='py-4 font-semibold text-lg'>Kontaktformular</h2>
      <h3 className='py-2 text-base'>Art und Zweck der Verarbeitung:</h3>
      <p>
      ...
      <p></p>
      <h2 className='py-4 font-semibold text-lg'>SSL-Verschlüsselung</h2>
      <p>
      ...
      <h3 className='py-2 text-base'>Einzelfallbezogenes Widerspruchsrecht</h3>
      <p>
      ...
      <h3 className='py-2 text-base'>Empfänger eines Widerspruchs</h3>
      <p>
        Delivery+
        <br />
        info@delivery.plus
