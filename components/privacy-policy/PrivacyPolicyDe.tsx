    ...
    return (
        <div>
            ...
            <p>
                ...
                Geschäftsleitung der Delivery Plus. Eine Nutzung der
                Internetseiten der Delivery Plus ist grundsätzlich ohne jede
            ...
            <p>
                ...
                die Delivery Plus geltenden landesspezifischen
            ...
            <p>
                ...
                die Delivery Plus keine Rückschlüsse auf die betroffene Person.
                ...
                Delivery Plus daher einerseits statistisch und ferner mit dem
            ...
            <p>
                Die Internetseite der Delivery Plus enthält aufgrund von
            ...
            <ul>
                ...
                <li>
                    ...
                    <p>
                        ...
                        Daten, die bei der Delivery Plus gespeichert sind,
                        veranlassen möchte, kann sie sich hierzu jederzeit an
                        einen Mitarbeiter des für die Verarbeitung
                        Verantwortlichen wenden. Der Mitarbeiter der Delivery
                        Plus wird veranlassen, dass dem Löschverlangen
                        unverzüglich nachgekommen wird.
                    </p>

                    <p>
                        Wurden die personenbezogenen Daten von der Delivery Plus
                        ...
                        trifft die Delivery Plus unter Berücksichtigung der
                        ...
                        Mitarbeiter der Delivery Plus wird im Einzelfall das
                ...
                <li>
                    ...
                    <p>
                        ...
                        Mitarbeiter der Delivery Plus wenden.
                    </p>
                </li>
                <li>
                    <h4 className="py-4 font-semibold text-lg">
                    ...
                    <p>
                        Die Delivery Plus verarbeitet die personenbezogenen
                        Daten im Falle des Widerspruchs nicht mehr, es sei denn,
                    ...
                    <p>
                        ...
                        Delivery Plus der Verarbeitung für Zwecke der
                        Direktwerbung, so wird die Delivery Plus die
                    ...
                    <p>
                        ...
                        Daten, die bei der Delivery Plus zu wissenschaftlichen
                    ...
                    <p>
                        ...
                        betroffene Person direkt an jeden Mitarbeiter der
                        Delivery Plus oder einen anderen Mitarbeiter wenden. Der
                ...
                <li>
                    ...
                    <p>
                        ...
                        Person, trifft die Delivery Plus angemessene Maßnahmen,
                        um die Rechte und Freiheiten sowie die berechtigten
            ...
            <h4 className="py-4 font-semibold text-lg">
                8. Zahlungsart: Datenschutzbestimmungen zu Klarna als
                Zahlungsart
            </h4>
            <p>
            ...
            <h4 className="py-4 font-semibold text-lg">
                9. Zahlungsart: Datenschutzbestimmungen zu PayPal als
                Zahlungsart
            </h4>
            <p>
                Der für die Verarbeitung Verantwortliche hat auf dieser
                ...
                Möglichkeit, virtuelle Zahlungen über Kreditkarten abzuwickeln,
                wenn ein Nutzer kein PayPal-Konto unterhält. Ein PayPal-Konto
                wird über eine E-Mail-Adresse geführt, weshalb es keine
                klassische Kontonummer gibt. PayPal ermöglicht es,
                Online-Zahlungen an Dritte auszulösen oder auch Zahlungen zu
                empfangen. PayPal übernimmt ferner Treuhänderfunktionen und
            ...
            <p>
                ...
                automatisiert Daten der betroffenen Person an PayPal
            ...
            <p>
                ...
                wird PayPal personenbezogene Daten insbesondere dann
                übermitteln, wenn ein berechtigtes Interesse für die
                Übermittlung gegeben ist. Die zwischen PayPal und dem für die
            ...
            <h4 className="py-4 font-semibold text-lg">
                10. Zahlungsart: Datenschutzbestimmungen zu Skrill als
                Zahlungsart
            </h4>
            <p>
                Der für die Verarbeitung Verantwortliche hat auf dieser
                Internetseite Komponenten von Skrill integriert. Skrill ist ein
                Online-Zahlungsdienstleister. Die Zahlungen werden über das
                sogenannte Skrill-Wallet abgewickelt, welches eine virtuelle
                elektronische Geldbörse darstellt. Skrill bietet auch die
                Möglichkeit, virtuelle Zahlungen über Kreditkarten abzuwickeln.
                Ein Skrill-Wallet wird über eine E-Mail-Adresse geführt. Skrill
                ermöglicht es, Online-Zahlungen an Dritte auszulösen oder
                Zahlungen zu empfangen.
            </p>

            <p>
                Betreibergesellschaft von Skrill ist die Skrill Limited, 25
                Canada Square, London E14 5LQ, United Kingdom.
            </p>

            <p>
                Wählt die betroffene Person während des Bestellvorgangs in
                unserem Online-Shop als Zahlungsmöglichkeit „Skrill“ aus, werden
                automatisiert Daten der betroffenen Person an Skrill
                übermittelt. Mit der Auswahl dieser Zahlungsoption willigt die
                betroffene Person in die zur Zahlungsabwicklung erforderliche
                Übermittlung personenbezogener Daten ein.
            </p>
            ...
            <p>
                Bei den mit Skrill ausgetauschten personenbezogenen Daten
                handelt es sich um die Kaufsumme und die E-Mail-Adresse, die zur
                Zahlungsabwicklung notwendig sind. Die Übermittlung der Daten
                bezweckt die Zahlungsabwicklung und die Betrugsprävention. Der
                für die Verarbeitung Verantwortliche wird Skrill andere
                personenbezogene Daten auch dann übermitteln, wenn ein
                berechtigtes Interesse für die Übermittlung gegeben ist. Die
                zwischen Skrill und dem für die Verarbeitung Verantwortlichen
                ausgetauschten personenbezogenen Daten werden von Skrill unter
                Umständen an Wirtschaftsauskunfteien übermittelt. Diese
                Übermittlung bezweckt die Identitäts- und Bonitätsprüfung.
            </p>

            <p>
                Skrill gibt die personenbezogenen Daten gegebenenfalls an
                verbundene Unternehmen und Leistungserbringer oder
                Subunternehmer weiter, soweit dies zur Erfüllung der
                vertraglichen Verpflichtungen erforderlich ist oder die Daten im
                Auftrag verarbeitet werden sollen.
            ...
            <p>
                Die betroffene Person hat die Möglichkeit, die Einwilligung zum
                Umgang mit personenbezogenen Daten jederzeit gegenüber Skrill zu
                widerrufen. Ein Widerruf wirkt sich nicht auf personenbezogene
                Daten aus, die zwingend zur (vertragsgemäßen) Zahlungsabwicklung
                verarbeitet, genutzt oder übermittelt werden müssen.
            </p>
            ...
            <h4 className="py-4 font-semibold text-lg">
                11. Zahlungsart: Datenschutzbestimmungen zu Sofortüberweisung
                als Zahlungsart
            </h4>
            <p>
                Der für die Verarbeitung Verantwortliche hat auf dieser
            ...
            <p>
                ...
                können unter https://www.klarna.com/sofort/datenschutz/
                abgerufen werden.
            </p>
            ...
            <h4 className="py-4 font-semibold text-lg">
                14. Dauer, für die die personenbezogenen Daten gespeichert
                werden
            </h4>
            <p>
            ...
            <h4 className="py-4 font-semibold text-lg">
                15. Gesetzliche oder vertragliche Vorschriften zur
