  ...
  return (
    <div>
      ...
      <p>
        ...
        Geschäftsleitung der Delivery Plus. Eine Nutzung der Internetseiten der
        Delivery Plus ist grundsätzlich ohne jede Angabe personenbezogener Daten
      ...
      <p>
        ...
        Übereinstimmung mit den für die Delivery Plus geltenden
      ...
      <p>
        Die Delivery Plus hat als für die Verarbeitung Verantwortlicher
      ...
      <h4 className='py-4 font-semibold text-lg'>1. Begriffsbestimmungen</h4>
      <p>
        Die Datenschutzerklärung der Delivery Plus beruht auf den
      ...
      <ul>
        <li>
          <h4 className='py-4 font-semibold text-lg'>a) personenbezogene Daten</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>b) betroffene Person</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>c) Verarbeitung</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>d) Einschränkung der Verarbeitung</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>f) Pseudonymisierung</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>h) Auftragsverarbeiter</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>i) Empfänger</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>j) Dritter</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>k) Einwilligung</h4>
          <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>2. Name und Anschrift des für die Verarbeitung Verantwortlichen</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>3. Erfassung von allgemeinen Daten und Informationen</h4>
      <p>
        Die Internetseite der Delivery Plus erfasst mit jedem Aufruf der
      ...
      <p>
        ...
        Delivery Plus keine Rückschlüsse auf die betroffene Person. Diese
        ...
        erhobenen Daten und Informationen werden durch die Delivery Plus daher
      ...
      <h4 className='py-4 font-semibold text-lg'>4. Registrierung auf unserer Internetseite</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>5. Kontaktmöglichkeit über die Internetseite</h4>
      <p>
        Die Internetseite der Delivery Plus enthält aufgrund von gesetzlichen
      ...
      <h4 className='py-4 font-semibold text-lg'>7. Rechte der betroffenen Person</h4>
      <ul>
        <li>
          <h4 className='py-4 font-semibold text-lg'>a) Recht auf Bestätigung</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>b) Recht auf Auskunft</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>c) Recht auf Berichtigung</h4>
          <p>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>d) Recht auf Löschung (Recht auf Vergessen werden)</h4>
          <p>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
          ...
          <p>
            ...
            Delivery Plus gespeichert sind, veranlassen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Delivery Plus wird
            veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Delivery Plus öffentlich
            ...
            so trifft die Delivery Plus unter Berücksichtigung der verfügbaren
            ...
            Mitarbeiter der Delivery Plus wird im Einzelfall das Notwendige
            veranlassen.
          </p>
        </li>
        <li>
          <h4 className='py-4 font-semibold text-lg'>e) Recht auf Einschränkung der Verarbeitung</h4>
          <p>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
          ...
          <p>
            ...
            bei der Delivery Plus gespeichert sind, verlangen möchte, kann sie
            sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Delivery Plus wird die
            Einschränkung der Verarbeitung veranlassen.
          </p>
        </li>
        <li>
          <h4 className='py-4 font-semibold text-lg'>f) Recht auf Datenübertragbarkeit</h4>
          <p>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Delivery Plus
            wenden.
          </p>
        </li>
        <li>
          <h4 className='py-4 font-semibold text-lg'>g) Recht auf Widerspruch</h4>
          <p>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
          ...
          <p>
            Die Delivery Plus verarbeitet die personenbezogenen Daten im Falle
          ...
          <p>
            Verarbeitet die Delivery Plus personenbezogene Daten, um
            ...
            steht. Widerspricht die betroffene Person gegenüber der Delivery
            Plus der Verarbeitung für Zwecke der Direktwerbung, so wird die
            Delivery Plus die personenbezogenen Daten nicht mehr für diese
            Zwecke verarbeiten.
          </p>
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Delivery Plus zu
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der Delivery Plus oder einen
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die Delivery Plus angemessene
      ...
      <h4 className='py-4 font-semibold text-lg'>8. Zahlungsart: Datenschutzbestimmungen zu Klarna als Zahlungsart</h4>
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
        Komponenten von Klarna integriert. Klarna ist ein
        Online-Zahlungsdienstleister, der den Kauf auf Rechnung oder eine
        flexible Ratenzahlung ermöglicht. Ferner werden von Klarna weitere
        Services, wie beispielsweise ein Käuferschutz oder eine Identitäts- und
        Bonitätsprüfung, angeboten.
      </p>

      <p>
        Betreibergesellschaft von Klarna ist die Klarna Bank AB, Sveavägen 46,
        111 34 Stockholm, Schweden.
      </p>

      <p>
        Wählt die betroffene Person während des Bestellvorgangs in unserem
        Online-Shop als Zahlungsmöglichkeit entweder den „Kauf auf Rechnung“
        oder „Ratenkauf“ aus, werden automatisiert Daten der betroffenen Person
        an Klarna übermittelt. Mit der Auswahl einer dieser Zahlungsoptionen
        willigt die betroffene Person in diese, zur Abwicklung des Rechnungs-
        oder Ratenkaufes oder zur Identitäts- und Bonitätsprüfung erforderliche,
        Übermittlung personenbezogener Daten ein.
      </p>

      <p>
        Bei den an Klarna übermittelten personenbezogenen Daten handelt es sich
        in der Regel um Vorname, Nachname, Adresse, Geburtsdatum, Geschlecht,
        Email-Adresse, IP-Adresse, Telefonnummer, Mobiltelefonnummer sowie um
        andere Daten, die zur Abwicklung eines Rechnungs- oder Ratenkaufs
        ...
        Bestellung stehen. Insbesondere kann es zum wechselseitigen Austausch
        von Zahlungsinformationen, wie Bankverbindung, Kartennummer,
        Gültigkeitsdatum und CVC-Code, Artikelanzahl, Artikelnummer, Daten zu
        Waren und Dienstleistungen, Preise und steuerliche Abgaben, Angaben zum
        früheren Kaufverhalten oder sonstige Angaben zur finanziellen Situation
      ...
      <p>
        ...
        Betrugsprävention. Der für die Verarbeitung Verantwortliche wird Klarna
        ...
        Klarna und dem für die Verarbeitung Verantwortlichen ausgetauschten
        personenbezogenen Daten werden von Klarna an Wirtschaftsauskunfteien
      ...
      <p>
        ...
        (Klarna Gruppe) und Leistungserbringer oder Subunternehmer weiter,
        soweit dies zur Erfüllung der vertraglichen Verpflichtungen erforderlich
        ist oder die Daten im Auftrag verarbeitet werden sollen.
      </p>
      ...
      <p>
        ...
        das bisherige Zahlungsverhalten der betroffenen Person sowie
        Wahrscheinlichkeitswerte für deren Verhalten in der Zukunft (sogenanntes
        Scoring). Die Berechnung des Scorings wird auf der Basis
      ...
      <p>
        ...
        mit personenbezogenen Daten jederzeit gegenüber Klarna zu widerrufen.
      ...
      <h4 className='py-4 font-semibold text-lg'>9. Zahlungsart: Datenschutzbestimmungen zu PayPal als Zahlungsart</h4>
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
      ...
      <h4 className='py-4 font-semibold text-lg'>
        10. Zahlungsart: Datenschutzbestimmungen zu Skrill als Zahlungsart
      </h4>
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
        Komponenten von Skrill integriert. Skrill ist ein
        Online-Zahlungsdienstleister. Die Zahlungen werden über das sogenannte
        Skrill-Wallet abgewickelt, welches eine virtuelle elektronische
        Geldbörse darstellt. Skrill bietet auch die Möglichkeit, virtuelle
        Zahlungen über Kreditkarten abzuwickeln. Ein Skrill-Wallet wird über
        eine E-Mail-Adresse geführt. Skrill ermöglicht es, Online-Zahlungen an
        Dritte auszulösen oder Zahlungen zu empfangen.
      </p>

      <p>
        Betreibergesellschaft von Skrill ist die Skrill Limited, 25 Canada
        Square, London E14 5LQ, United Kingdom.
      </p>

      <p>
        Wählt die betroffene Person während des Bestellvorgangs in unserem
        Online-Shop als Zahlungsmöglichkeit „Skrill“ aus, werden automatisiert
        Daten der betroffenen Person an Skrill übermittelt. Mit der Auswahl
        dieser Zahlungsoption willigt die betroffene Person in die zur
        Zahlungsabwicklung erforderliche Übermittlung personenbezogener Daten
        ein.
      </p>
      ...
      <p>
        Bei den mit Skrill ausgetauschten personenbezogenen Daten handelt es
        sich um die Kaufsumme und die E-Mail-Adresse, die zur Zahlungsabwicklung
        notwendig sind. Die Übermittlung der Daten bezweckt die
        Zahlungsabwicklung und die Betrugsprävention. Der für die Verarbeitung
        Verantwortliche wird Skrill andere personenbezogene Daten auch dann
        übermitteln, wenn ein berechtigtes Interesse für die Übermittlung
        gegeben ist. Die zwischen Skrill und dem für die Verarbeitung
        Verantwortlichen ausgetauschten personenbezogenen Daten werden von
        Skrill unter Umständen an Wirtschaftsauskunfteien übermittelt. Diese
      ...
      <p>
        Die betroffene Person hat die Möglichkeit, die Einwilligung zum Umgang
        mit personenbezogenen Daten jederzeit gegenüber Skrill zu widerrufen.
        Ein Widerruf wirkt sich nicht auf personenbezogene Daten aus, die
        zwingend zur (vertragsgemäßen) Zahlungsabwicklung verarbeitet, genutzt
        oder übermittelt werden müssen.
      </p>
      ...
      <p>
        ...
        https://www.skrill.com/de/fusszeile/datenschutzbestimmungen/ abgerufen
        werden.
      </p>

      <h4 className='py-4 font-semibold text-lg'>
        11. Zahlungsart: Datenschutzbestimmungen zu Sofortüberweisung als
        Zahlungsart
      </h4>
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
      ...
      <p>
        Betreibergesellschaft von Sofortüberweisung ist die Klarna Bank AB,
      ...
      <p>
        ...
        automatisiert Daten der betroffenen Person an Sofortüberweisung
      ...
      <p>
        ...
        technischer Überprüfung des Kontostandes und Abruf weiterer Daten zur
        Prüfung der Kontodeckung eine Überweisung an den Online-Händler aus. Die
        Durchführung der Finanztransaktion wird dem Online-Händler sodann
        automatisiert mitgeteilt.
      </p>

      <p>
        Bei den mit Sofortüberweisung ausgetauschten personenbezogenen Daten
        handelt es sich um Vorname, Nachname, Adresse, Email-Adresse,
        IP-Adresse, Telefonnummer, Mobiltelefonnummer oder andere Daten, die zur
        Zahlungsabwicklung notwendig sind. Die Übermittlung der Daten bezweckt
        die Zahlungsabwicklung und die Betrugsprävention. Der für die
        Verarbeitung Verantwortliche wird Sofortüberweisung andere
        personenbezogene Daten auch dann übermitteln, wenn ein berechtigtes
        Interesse für die Übermittlung gegeben ist. Die zwischen
        Sofortüberweisung und dem für die Verarbeitung Verantwortlichen
        ausgetauschten personenbezogenen Daten werden von Sofortüberweisung
        unter Umständen an Wirtschaftsauskunfteien übermittelt. Diese
        Übermittlung bezweckt die Identitäts- und Bonitätsprüfung.
      </p>
      ...
      <p>
        Die betroffene Person hat die Möglichkeit, die Einwilligung zum Umgang
        mit personenbezogenen Daten jederzeit gegenüber Sofortüberweisung zu
        widerrufen. Ein Widerruf wirkt sich nicht auf personenbezogene Daten
        aus, die zwingend zur (vertragsgemäßen) Zahlungsabwicklung verarbeitet,
        genutzt oder übermittelt werden müssen.
      </p>

      <p>
        Die geltenden Datenschutzbestimmungen von Sofortüberweisung können unter
        https://www.klarna.com/sofort/datenschutz/ abgerufen werden.
      </p>

      <h4 className='py-4 font-semibold text-lg'>12. Rechtsgrundlage der Verarbeitung</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>14. Dauer, für die die personenbezogenen Daten gespeichert werden</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>16. Bestehen einer automatisierten Entscheidungsfindung</h4>
      <p>
