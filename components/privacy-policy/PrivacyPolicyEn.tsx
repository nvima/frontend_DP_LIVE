    ...
    return (
        <div>
            ...
            <p>
                ...
                for the management of the Delivery Plus. The use of the Internet
                pages of the Delivery Plus is possible without any indication of
                ...
                necessary and there is no statutory basis for such processing,
            ...
            <p>
                ...
                protection regulations applicable to the Delivery Plus. By means
                of this data protection declaration, our enterprise would like
                to inform the general public of the nature, scope, and purpose
            ...
            <p>
                As the controller, the Delivery Plus has implemented numerous
            ...
            <h4 className="py-4 font-semibold text-lg">1. Definitions</h4>
            <p>
                The data protection declaration of the Delivery Plus is based on
            ...
            <ul>
                ...
                <li>
                    <h4 className="py-4 font-semibold text-lg">e) Profiling</h4>
                    <p>
                ...
                <li>
                    <h4 className="py-4 font-semibold text-lg">h) Processor</h4>
                    <p>
                ...
                <li>
                    <h4 className="py-4 font-semibold text-lg">i) Recipient</h4>
                    <p>
                ...
                <li>
                    <h4 className="py-4 font-semibold text-lg">k) Consent</h4>
                    <p>
            ...
            <p>
                The website of the Delivery Plus collects a series of general
            ...
            <p>
                When using these general data and information, the Delivery Plus
                ...
                Therefore, the Delivery Plus analyzes anonymously collected data
            ...
            <p>
                ...
                the respective input mask used for the registration. The
                personal data entered by the data subject are collected and
                stored exclusively for internal use by the controller, and for
                his own purposes. The controller may request transfer to one or
                more processors (e.g. a parcel service) that also uses personal
                data for an internal purpose which is attributable to the
                controller.
            </p>
            ...
            <p>
                ...
                background that this is the only way to prevent the misuse of
                our services, and, if necessary, to make it possible to
                investigate committed offenses. Insofar, the storage of this
                data is necessary to secure the controller. This data is not
                passed on to third parties unless there is a statutory
                obligation to pass on the data, or if the transfer serves the
                aim of criminal prosecution.
            </p>

            <p>
                The registration of the data subject, with the voluntary
                indication of personal data, is intended to enable the
                controller to offer the data subject contents or services that
                may only be offered to registered users due to the nature of the
                matter in question. Registered persons are free to change the
                personal data specified during the registration at any time, or
                to have them completely deleted from the data stock of the
                controller.
            </p>
            ...
            <p>
                ...
                correct or erase personal data at the request or indication of
                the data subject, insofar as there are no statutory storage
                obligations. The entirety of the controller’s employees are
                available to the data subject in this respect as contact
                persons.
            </p>
            ...
            <p>
                The website of the Delivery Plus contains information that
                ...
                automatically stored. Such personal data transmitted on a
                voluntary basis by a data subject to the data controller are
                stored for the purpose of processing or contacting the data
                subject. There is no transfer of this personal data to third
                parties.
            </p>
            ...
            <ul>
                ...
                <li>
                    ...
                    <p>
                        ...
                        of access, he or she may, at any time, contact any
                        employee of the controller.
                    </p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            to Article 21(1) of the GDPR and there are no
                        ...
                        <li>
                            ...
                            the offer of information society services referred
                    ...
                    <p>
                        ...
                        stored by the Delivery Plus, he or she may, at any time,
                        contact any employee of the controller. An employee of
                        Delivery Plus shall promptly ensure that the erasure
                        request is complied with immediately.
                    </p>

                    <p>
                        Where the controller has made personal data public and
                        is obliged pursuant to Article 17(1) to erase the
                        ...
                        processing is not required. An employees of the Delivery
                        Plus will arrange the necessary measures in individual
                        cases.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        ...
                        processing of personal data stored by the Delivery Plus,
                        he or she may at any time contact any employee of the
                        controller. The employee of the Delivery Plus will
                ...
                <li>
                    ...
                    <p>
                        The Delivery Plus shall no longer process the personal
                    ...
                    <p>
                        If the Delivery Plus processes personal data for direct
                        marketing purposes, the data subject shall have the
                        right to object at any time to processing of personal
                        data concerning him or her for such marketing. This
                        applies to profiling to the extent that it is related to
                        such direct marketing. If the data subject objects to
                        the Delivery Plus to the processing for direct marketing
                        purposes, the Delivery Plus will no longer process the
                    ...
                    <p>
                        ...
                        the Delivery Plus for scientific or historical research
                        purposes, or for statistical purposes pursuant to
                        Article 89(1) of the GDPR, unless the processing is
                    ...
                    <p>
                        ...
                        subject may contact any employee of the Delivery Plus.
                        In addition, the data subject is free in the context of
                        the use of information society services, and
                ...
                <li>
                    ...
                    <p>
                        ...
                        and a data controller, or (2) it is based on the data
                        subject's explicit consent, the Delivery Plus shall
                ...
                <li>
                    ...
                    <p>
                        ...
                        contact any employee of the Delivery Plus.
                    </p>
                </li>
            </ul>
            <h4 className="py-4 font-semibold text-lg">
                8. Payment Method: Data protection provisions about the use of
                Klarna as a payment processor
            </h4>
            <p>
                On this website, the controller has integrated Klarna
                components. Klarna is an online payment service provider, which
                allows purchases on an account or a flexible installment
                payment. Klarna also offers other services, such as buyer
                protection and identity or creditworthiness checks.
            </p>

            <p>
                The operating company of Klarna is Klarna Bank AB, Sveavägen 46,
                111 34 Stockholm, Schweden.
            </p>

            <p>
                If the data subject selects the "purchase on account" or
                "installment purchase" during the ordering process in our online
                shop as a payment option, the data of the data subject is
                automatically transmitted to Klarna. By selecting one of these
                payment options, the data subject agrees to this transmission of
                personal data required for the processing of the invoice or
                installment purchase, or identity and creditworthiness checks.
            </p>

            <p>
                The personal data transmitted to Klarna is usually first name,
                surname, address, date of birth, sex, email address, IP address,
                telephone number, mobile phone number, as well as other data
                necessary for the processing of an invoice or installment
                purchase. The processing of the purchase contract also requires
                such personal data, which are in connection with the respective
                order. In particular, the exchange of payment information such
                as bank details, card number, date of validity and CVC code,
                cumulative number, item number, data on goods and services,
                prices and taxes, information on the previous purchase behavior
                or other details of the financial situation of the data subject.
            </p>

            <p>
                The purpose of the transmission of the data is, in particular,
                the identification check, payment administration, andfraud
                prevention. The controller shall provide Klarna with personal
                data, in particular, if a legitimate interest in the
                transmission exists. The personal data exchanged between Klarna
                and the data subject for the data processing shall be
                transmitted by Klarna to economic agencies. This transmission is
                intended for identity and creditworthiness checks.
            </p>

            <p>
                Klarna shall also pass on the personal data to affiliates
                (Klarna Group) and service providers or subcontractors as far as
                this is necessary to fulfill contractual obligations or to
                process the data in the order.
            </p>

            <p>
                Klarna collects and uses data and information on the previous
                payment behavior of the data subject as well as probability
                values for their behavior in the future (so-called scoring) in
                order to decide on the reasoning, implementation or termination
                of a contractual relationship. The calculation of scoring is
                carried out on the basis of scientifically-recognized
                mathematical-statistical methods.
            </p>

            <p>
                The data subject is able to revoke the consent to the handling
                of personal data at any time from Klarna. A revocation shall not
                have any effect on personal data which must be processed, used
                or transmitted in accordance with (contractual) payment
                processing.
            </p>

            <p>
                The applicable data protection provisions of Klarna may be
                retrieved under
                https://cdn.klarna.com/1.0/shared/content/policy/data/de_de/data_protection.pdf.
            </p>

            <h4 className="py-4 font-semibold text-lg">
                9. Payment Method: Data protection provisions about the use of
                PayPal as a payment processor
            </h4>
            <p>
                On this website, the controller has integrated components of
                PayPal. PayPal is an online payment service provider. Payments
                are processed via so-called PayPal accounts, which represent
                virtual private or business accounts. PayPal is also able to
                process virtual payments through credit cards when a user does
                not have a PayPal account. A PayPal account is managed via an
                e-mail address, which is why there are no classic account
                numbers. PayPal makes it possible to trigger online payments to
                third parties or to receive payments. PayPal also accepts
            ...
            <p>
                ...
                the online shop during the ordering process, we automatically
                transmit the data of the data subject to PayPal. By selecting
                this payment option, the data subject agrees to the transfer of
                personal data required for payment processing.
            </p>
            ...
            <p>
                ...
                processing. The processing of the purchase contract also
            ...
            <p>
                ...
                transmission is given. The personal data exchanged between
            ...
            <p>
                ...
                and service providers or subcontractors to the extent that this
                is necessary to fulfill contractual obligations or for data to
            ...
            <p>
                On this website, the controller has integrated components by
                Skrill. Skrill is an online payment service provider. Payments
                are made via the so-called Skrill wallet, which is a virtual
                electronic wallet. Skrill also offers the possibility to make
                virtual payments via credit cards. A Skrill wallet is managed
                via an e-mail address. Skrill makes it possible to trigger
                online payments to third parties or to receive payments.
            </p>

            <p>
                The operating company of Skrill is Skrill Limited, 25 Canada
                Square, London E14 5LQ, United Kingdom.
            </p>

            <p>
                If the data subject chooses "Skrill" as the payment option
                during the ordering process in our online-shop, the data will be
                transmitted automatically to Skrill. By selecting this payment
                option, the data subject agrees to the transmission of personal
                data required for payment processing.
            </p>

            <p>
                The personal data exchanged with Skrill is the purchase sum and
                e-mail address, which are both necessary for payment processing.
                The transmission of data is aimed at payment processing and
                fraud prevention. The controller will also provide Skrill with
                other personal data in the case, if a legitimate interest in the
                transmission exists. The personal data exchanged between Skrill
                and the data subject shall be transmitted by Skrill to the
                economic agencies. This transmission is intended for identity
                and creditworthiness checks.
            </p>

            <p>
                If necessary, Skrill will pass on personal data to affiliates
                and service providers or subcontractors to the extent necessary
                to fulfill contractual obligations or to process the data in the
                order.
            </p>

            <p>
                The data subject has the possibility to revoke the consent to
                the handling of personal data at any time from Skrill. A
                revocation shall not have any effect on personal data which must
                be processed, used or transmitted in accordance with
                (contractual) payment processing.
            </p>

            <p>
                The applicable data protection provisions of Skrill may be
                retrieved under https://www.skrill.com/en/footer/privacypolicy/.
            </p>
            ...
            <p>
                On this website, the controller has integrated components of
                Sofortüberweisung. Sofortüberweisung is a payment service that
                allows cashless payment of products and services on the
                Internet. Sofortüberweisung is a technical procedure by which
                the online dealer immediately receives a payment confirmation.
                This enables a trader to deliver goods, services or downloads to
                the customer immediately after ordering.
            </p>

            <p>
                The operating company of Sofortüberweisung is Klarna Bank AB,
                Sveavägen 46, 111 34 Stockholm, Schweden.
            </p>

            <p>
                If the data subject chooses "immediate transfer" as the payment
                option in our online shop during the ordering process, the data
                of the data subject will be transmitted to Sofortüberweisung. By
                selecting this payment option, the data subject agrees to the
                transmission of personal data required for payment processing.
            </p>

            <p>
                In the case of purchase processing via direct transfer, the
                buyer sends the PIN and the TAN to Sofort GmbH.
                Sofortüberweisung then carries out a transfer to the online
                merchant after technical verification of the account status and
                retrieval of additional data to check the account assignment.
                The online trader is then automatically informed of the
                execution of the financial transaction.
            </p>

            <p>
                The personal data exchanged with Sofortüberweisung is the first
                name, last name, address, email address, IP address, telephone
                number, mobile phone number, or other data necessary for payment
                processing. The transmission of the data is aimed at payment
                processing and fraud prevention. The controller shall
                immediately transfer other personal data, even if a legitimate
                interest in the transmission exists. The personal data exchanged
                between Sofortüberweisung and the controller shall be
                transmitted by Sofortüberweisung to economic credit agencies.
                This transmission is intended for identity and creditworthiness
                checks.
            </p>

            <p>
                Sofortüberweisung provides personal data to affiliated companies
                and service providers or subcontractors as far as this is
                necessary for the fulfillment of contractual obligations or data
                in order to be processed.
            </p>

            <p>
                The data subject has the possibility to revoke the consent to
                the handling of personal data at any time from
                Sofortüberweisung. A revocation shall not have any effect on
                personal data which must be processed, used or transmitted in
                accordance with (contractual) payment processing.
            </p>

            <p>
                The applicable data protection provisions of Sofortüberweisung
