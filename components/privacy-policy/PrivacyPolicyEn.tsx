  ...
  return (
    <div>
      ...
      <p>
        ...
        the Delivery Plus. The use of the Internet pages of the Delivery Plus is
      ...
      <p>
        ...
        Delivery Plus. By means of this data protection declaration, our
      ...
      <p>
        As the controller, the Delivery Plus has implemented numerous technical
      ...
      <p>
        The data protection declaration of the Delivery Plus is based on the
      ...
      <ul>
        <li>
          <h4 className='py-4 font-semibold text-lg'>a) Personal data</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>b) Data subject</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>c) Processing</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>d) Restriction of processing</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>f) Pseudonymisation</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>g) Controller or controller responsible for the processing</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>j) Third party</h4>
          <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>2. Name and Address of the controller</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>3. Collection of general data and information</h4>
      <p>
        The website of the Delivery Plus collects a series of general data and
      ...
      <p>
        When using these general data and information, the Delivery Plus does
        ...
        prosecution in case of a cyber-attack. Therefore, the Delivery Plus
      ...
      <h4 className='py-4 font-semibold text-lg'>4. Registration on our website</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>5. Contact possibility via the website </h4>
      <p>
        The website of the Delivery Plus contains information that enables a
      ...
      <h4 className='py-4 font-semibold text-lg'>6. Routine erasure and blocking of personal data</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>7. Rights of the data subject</h4>
      <ul>
        <li>
          <h4 className='py-4 font-semibold text-lg'>a) Right of confirmation</h4>
          <p>
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>b) Right of access</h4>
          <p>
            Each data subject shall have the right granted by the European
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>c) Right to rectification </h4>
          <p>
            Each data subject shall have the right granted by the European
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>d) Right to erasure (Right to be forgotten) </h4>
          <p>
            Each data subject shall have the right granted by the European
          ...
          <p>
            ...
            Delivery Plus, he or she may, at any time, contact any employee of
            the controller. An employee of Delivery Plus shall promptly ensure
          ...
          <p>
            ...
            as processing is not required. An employees of the Delivery Plus
            will arrange the necessary measures in individual cases.
          </p>
        </li>
        <li>
          <h4 className='py-4 font-semibold text-lg'>e) Right of restriction of processing</h4>
          <p>
            Each data subject shall have the right granted by the European
          ...
          <p>
            ...
            stored by the Delivery Plus, he or she may at any time contact any
            employee of the controller. The employee of the Delivery Plus will
            arrange the restriction of the processing.
          </p>
        </li>
        <li>
          <h4 className='py-4 font-semibold text-lg'>f) Right to data portability</h4>
          <p>
            Each data subject shall have the right granted by the European
          ...
          <p>
            ...
            may at any time contact any employee of the Delivery Plus.
          </p>
        </li>
        <li>
          <h4 className='py-4 font-semibold text-lg'>g) Right to object</h4>
          <p>
            Each data subject shall have the right granted by the European
          ...
          <p>
            The Delivery Plus shall no longer process the personal data in the
          ...
          <p>
            If the Delivery Plus processes personal data for direct marketing
            ...
            Delivery Plus to the processing for direct marketing purposes, the
            Delivery Plus will no longer process the personal data for these
            purposes.
          </p>
          ...
          <p>
            ...
            data concerning him or her by the Delivery Plus for scientific or
          ...
          <p>
            ...
            contact any employee of the Delivery Plus. In addition, the data
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>h) Automated individual decision-making, including profiling</h4>
          <p>
            Each data subject shall have the right granted by the European
          ...
          <p>
            ...
            consent, the Delivery Plus shall implement suitable measures to
        ...
        <li>
          <h4 className='py-4 font-semibold text-lg'>i) Right to withdraw data protection consent </h4>
          <p>
            Each data subject shall have the right granted by the European
      ...
      <h4 className='py-4 font-semibold text-lg'>
        8. Payment Method: Data protection provisions about the use of Klarna as
        a payment processor
      </h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>
        9. Payment Method: Data protection provisions about the use of PayPal as
        a payment processor
      </h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>
        10. Payment Method: Data protection provisions about the use of Skrill
      ...
      <p>
        The operating company of Skrill is Skrill Limited, 25 Canada Square,
      ...
      <h4 className='py-4 font-semibold text-lg'>12. Legal basis for the processing </h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>
        13. The legitimate interests pursued by the controller or by a third
        party
      </h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>14. Period for which the personal data will be stored</h4>
      <p>
      ...
      <h4 className='py-4 font-semibold text-lg'>16. Existence of automated decision-making</h4>
      <p>
